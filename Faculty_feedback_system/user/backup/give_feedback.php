...
<tr>
<td><b>1:</b> Has the Teacher covered entire Syllabus as prescribed by University?</td>  
<td><select class="form-control" style="width:100px;float:left" name="quest1">
<option>YES</option>
					<option>NO</option></td>
...
<tr>
<td><b>2:</b>Has the Teacher covered relevant topics beyond Syllabus?</td> 
<td><select class="form-control" style="width:100px;float:left" name="quest2">
<option>YES</option>
					<option>NO</option></td>
</tr>
...
<td><select class="form-control" style="width:100px;float:left" name="quest3" required> 5
...
<td><select class="form-control" style="width:100px;float:left" name="quest4" required> 5
<option value="">Rate</option>
<option>1</option>
<option>2</option>
<option>3</option>
...
<td><select class="form-control" style="width:100px;float:left" name="quest5" required> 5
<option value="">Rate</option>
<option>1</option>
<option>2</option>
<option>3</option>
...
<td><select class="form-control" style="width:100px;float:left" name="quest6" required> 5
<option value="">Rate</option>
<option>1</option>
<option>2</option>
<option>3</option>
...
<td><select class="form-control" style="width:100px;float:left" name="quest7" required> 5
<option value="">Rate</option>
<option>1</option>
<option>2</option>
<option>3</option>
...
<td><select class="form-control" style="width:100px;float:left" name="quest8" required> 5
<option value="">Rate</option>
<option>1</option>
<option>2</option>
<option>3</option>
...
<td><select class="form-control" style="width:100px;float:left" name="quest9" required> 5
<option value="">Rate</option>
<option>1</option>
<option>2</option>
<option>3</option>
...
<td><select class="form-control" style="width:100px;float:left" name="quest10" required> 5
<option value="">Rate</option>
<option>1</option>
<option>2</option>
<option>3</option>
...
<td><select class="form-control" style="width:100px;float:left" name="quest11" required> 5
<option value="">Rate</option>
<option>1</option>
<option>2</option>
<option>3</option>
...
<td><select class="form-control" style="width:100px;float:left" name="quest12" required> 5
<option value="">Rate</option>
<option>1</option>
<option>2</option>
<option>3</option>
