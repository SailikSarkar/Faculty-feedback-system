...
<li><a href="dashboard.php?info=feedback_average"><i class="fa fa-eye"></i> feedback Average</a></li>
        ...
        <li>
			<a href="dashboard.php?info=batch_move"><i class="fa fa-eye"></i> Batch Transfer  </a>
		</li>

        <li>
			<a href="dashboard.php?info=delete_all_student"><i class="fa fa-eye"></i> Batch Transfer try 2  </a>
		</li>

        <li>
			<a href="dashboard.php?info=transfer2"><i class="fa fa-eye"></i> Batch Transfer try 3 </a>
		</li>
                	...
                	<?php 
								...
								if($info!="")
								{
									...
									elseif($info=="contact")
                                        ...
                                        elseif($info=="transfer2")
										{
											include('transfer2.php');
										}
                                        elseif($info=="batch_move")
										{
											include('batch_move.php');
										}

                                        elseif($info=="delete_all_student")
										{
											include('delete_all_student.php');
										}
