...
{
//Count total Votes
$r=mysqli_query($conn,"select * from feedback where subject_id='$subject'");
$c=mysqli_num_rows($r);	
echo "<h1><B>Total Student Attempts : ".$c."</B></h1>";
...
//question 1 start
error_reporting(1);
$q=mysqli_query($conn,"select * from feedback where subject_id='$subject'");
...
//question 2 start
$q2=mysqli_query($conn,"select * from feedback where subject_id='$subject'");
