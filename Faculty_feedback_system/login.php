...
<form method="post">
	<div class="row">
		...
		<div class="col-sm-4"><h3><b>STUDENT LOGIN FORM</b></h3></div>
	</div>
	...
	<div class="row" style="margin-top:10px">
		<div class="col-sm-4"><h4><b>ENTER YOUR EMAIL</b></h4></div>
		<div class="col-sm-5">
		<input type="email" name="e" class="form-control"/></div>
	</div>
	
	<div class="row" style="margin-top:10px">
		<div class="col-sm-4"><h4><b>ENTER YOUR PASSWORD</b></h4></div>
		<div class="col-sm-5">
